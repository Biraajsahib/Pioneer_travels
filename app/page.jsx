...
const FontStyle = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { background: #080808; color: #e8e2d9; font-family: 'Manrope', sans-serif; overflow-x: hidden; -webkit-text-size-adjust: 100%; }
    ...
    .card-hover:hover { background: rgba(255,255,255,0.06) !important; border-color: rgba(201,169,110,0.3) !important; transform: translateY(-3px); }
    ...
    .btn-gold:hover { background: #E2C97E; transform: translateY(-1px); }
    ...
    .nav-link {
      ...
      letter-spacing: 1.5px; text-transform: uppercase; color: rgba(232,226,217,0.65); cursor: pointer;
    ...
    .mobile-menu button {
      ...
      color: #e8e2d9; transition: color 0.3s ease;
    }
    .mobile-menu button:hover { color: #C9A96E; }

    /* MISC */
    .tag { display: inline-block; font-family: 'Manrope', sans-serif; font-size: 10px; font-weight: 600; letter-spacing: 3px; text-transform: uppercase; color: #C9A96E; }
    .divider-gold { width: 36px; height: 1px; background: #C9A96E; margin: 0 auto; }
    ...
    .booking-input:focus { border-color: rgba(201,169,110,0.5); background: rgba(255,255,255,0.07); }
    .booking-input::placeholder { color: rgba(232,226,217,0.28); }
    .booking-input option { background: #111; color: #e8e2d9; }

    /* SERVICE CARD — fix button text color */
    .service-card-btn { color: #e8e2d9 !important; }
    .service-card-btn * { color: inherit; }

    /* ONWARDS */
    .onwards-link { cursor: pointer; transition: color 0.3s ease; }
    .onwards-link:hover { color: #C9A96E !important; }
    ...
    .driver-tab {
      ...
      border: 1px solid rgba(255,255,255,0.12); color: rgba(232,226,217,0.5); background: transparent;
    }
    .driver-tab.active { background: #C9A96E; color: #0a0806; border-color: #C9A96E; }
    .driver-tab:hover:not(.active) { border-color: rgba(201,169,110,0.4); color: #C9A96E; }

    /* Transmission toggle */
    .trans-btn {
      flex: 1; padding: 14px 10px; border-radius: 10px; cursor: pointer;
      font-family: 'Manrope', sans-serif; font-size: 13px; font-weight: 500;
      letter-spacing: 0.5px; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.1);
      color: rgba(232,226,217,0.5); background: transparent;
    }
    .trans-btn.active { background: rgba(201,169,110,0.15); border-color: rgba(201,169,110,0.5); color: #C9A96E; }
    .trans-btn:hover:not(.active) { border-color: rgba(201,169,110,0.25); color: rgba(232,226,217,0.8); }

    /* Input label */
    .field-label {
      display: block; font-size: 10px; font-weight: 600; letter-spacing: 2px;
      text-transform: uppercase; color: rgba(201,169,110,0.7); margin-bottom: 8px;
    ...
    <>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        {[...navItems, { key: "contact", label: "Book Now" }].map(n => (
          <button key={n.key} onClick={() => go(n.key)} style={{ color: page === n.key ? gold : undefined }}>
            {n.label}
          </button>
        ))}
        <a href="tel:+919872130111" style={{ textDecoration: "none", marginTop: "8px" }}>
          <span className="btn-gold" style={{ padding: "13px 32px", borderRadius: "100px", fontSize: "13px" }}>
            Call Now
          </span>
        </a>
      </div>
    ...
    <section className="section-pad" style={{ borderTop: `1px solid ${border}` }}>
      <div ref={ref} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "56px" }}>
          ...
          <h2 className="serif" style={{ fontSize: "clamp(32px,4.5vw,52px)", fontWeight: 400, color: "#f5ede0" }}>
          ...
          <div className="reviews-grid" style={{ marginBottom: "56px" }}>
            {topReviews.map(r => (
              <div key={r.id} className="card-hover" style={{
                padding: "30px 26px", background: bgCard,
                border: `1px solid ${border}`, borderRadius: "20px", backdropFilter: "blur(16px)",
              }}>
                <StarDisplay rating={r.rating} size={17} />
                <p className="serif" style={{ fontSize: "18px", fontStyle: "italic", color: "#e8e2d9", lineHeight: "1.65", margin: "16px 0 18px", fontWeight: 300 }}>
                  "{r.text}"
                </p>
        ...
        {topReviews.length === 0 && (
          <div style={{ textAlign: "center", padding: "36px", color: "rgba(232,226,217,0.28)", marginBottom: "36px", fontSize: "14px" }}>
        ...
        <div ref={formRef} className="fade-up" style={{
          ...
          borderRadius: "22px", padding: "36px 32px", backdropFilter: "blur(20px)",
        }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div>
              <div style={{ fontSize: "10px", color: "rgba(232,226,217,0.38)", marginBottom: "9px", letterSpacing: "1.5px", textTransform: "uppercase" }}>Your Rating</div>
            ...
            <textarea className="review-input" placeholder="Tell us about your journey..." value={text}
              onChange={e => setText(e.target.value)} rows={4} maxLength={400} style={{ resize: "none" }} />
            ...
            <button className="btn-gold" onClick={handleSubmit} style={{ padding: "13px 30px", borderRadius: "100px", fontSize: "12px", width: "fit-content" }}>
              Submit Review
            </button>
          </div>
        </div>
...
function DriverPage() {
  ...
  const handleRequest = () => {
    ...
    setSubmitted(true);
    setTimeout(() => {
      window.open(`https://wa.me/919872130111?text=${buildWhatsAppMessage()}`, "_blank");
    }, 600);
  };

  const inputStyle = (field) => ({
    ...{},
    border: errors[field] ? "1px solid rgba(232,100,100,0.5)" : "1px solid rgba(255,255,255,0.1)",
  });
    ...
    return (
      <div style={{ paddingTop: "70px", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div className="pop-in" style={{ textAlign: "center", padding: "40px 32px", maxWidth: "480px" }}>
          ...
          <h2 className="serif" style={{ fontSize: "36px", fontWeight: 400, color: "#f5ede0", marginBottom: "12px" }}>Request Sent</h2>
          <p style={{ color: "rgba(232,226,217,0.5)", fontSize: "15px", lineHeight: "1.8", marginBottom: "32px", fontWeight: 300 }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <button className="btn-outline" onClick={() => setSubmitted(false)} style={{ padding: "13px 28px", borderRadius: "100px" }}>
              New Request
            </button>
          </div>
        </div>
    ...
    <div style={{ paddingTop: "70px" }}>
      ...
      <section className="section-pad" style={{
        ...
        <div ref={r1} className="fade-up">
          ...
          <h1 className="serif" style={{ fontSize: "clamp(40px,6vw,66px)", fontWeight: 400, color: "#f5ede0", lineHeight: 1.05, marginBottom: "16px" }}>
            Driver <span style={{ fontStyle: "italic", color: gold }}>On Demand</span>
          </h1>
          <p style={{ color: "rgba(232,226,217,0.5)", fontSize: "15px", maxWidth: "520px", margin: "0 auto", fontWeight: 300, lineHeight: 1.8 }}>
            We provide a professional, verified driver for your own vehicle — manual or automatic.
            Share your details below and we will confirm pricing on WhatsApp.
          </p>
        </div>
      </section>

      {/* HOW IT WORKS */}
      <section className="section-pad" style={{ borderBottom: `1px solid ${border}` }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px,1fr))", gap: "2px", border: `1px solid ${border}`, borderRadius: "18px", overflow: "hidden" }}>
            {[
              ...
              <div key={s.n} style={{
                padding: "32px 22px", textAlign: "center", background: bgCard,
                borderRight: i < arr.length - 1 ? `1px solid ${border}` : "none",
              }}>
                <div className="serif" style={{ fontSize: "32px", fontWeight: 300, color: gold, lineHeight: 1, marginBottom: "10px" }}>{s.n}</div>
                <div style={{ fontSize: "14px", fontWeight: 600, color: "#f5ede0", marginBottom: "6px" }}>{s.t}</div>
                <div style={{ fontSize: "12px", color: "rgba(232,226,217,0.38)", fontWeight: 300, lineHeight: "1.6" }}>{s.d}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-pad">
        <div ref={r2} className="fade-up" style={{ maxWidth: "720px", margin: "0 auto" }}>
          {/* CARD */}
          <div style={{
            background: bgCard, border: `1px solid ${border}`,
            borderRadius: "28px", overflow: "hidden", backdropFilter: "blur(24px)",
          }}>
            {/* CARD HEADER */}
            <div style={{
              padding: "28px 36px", borderBottom: `1px solid ${border}`,
              background: "rgba(201,169,110,0.04)",
              display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px",
            }}>
              <h2 className="serif" style={{ fontSize: "26px", fontWeight: 400, color: "#f5ede0" }}>Book a Driver</h2>
              {/* TRIP TYPE TABS */}
            ...
            <div style={{ padding: "32px 36px", display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  <button className={`trans-btn ${transmission === "manual" ? "active" : ""}`} onClick={() => setTransmission("manual")}>
                    ⚙ Manual
                  </button>
                  <button className={`trans-btn ${transmission === "automatic" ? "active" : ""}`} onClick={() => setTransmission("automatic")}>
                    ◈ Automatic
                  </button>
                </div>
              </div>
              ...
              <div className="booking-grid">
                <div>
                  ...
                  <input className="booking-input" placeholder="Full name" value={name}
                    onChange={e => setName(e.target.value)} style={inputStyle("name")} />
                  {errors.name && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.name}</span>}
                </div>
                <div>
                  <label className="field-label">Phone Number</label>
                  <input className="booking-input" placeholder="+91 XXXXX XXXXX" value={phone} type="tel"
                    onChange={e => setPhone(e.target.value)} style={inputStyle("phone")} />
                  {errors.phone && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.phone}</span>}
                </div>
              </div>
              ...
              <div>
                ...
                <input className="booking-input" placeholder="Enter pickup address or area" value={pickup}
                  onChange={e => setPickup(e.target.value)} style={inputStyle("pickup")} />
                {errors.pickup && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.pickup}</span>}
              </div>
              <div>
                <label className="field-label">Drop Location</label>
                <input className="booking-input" placeholder="Enter drop address or area" value={drop}
                  onChange={e => setDrop(e.target.value)} style={inputStyle("drop")} />
                {errors.drop && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.drop}</span>}
              </div>
              ...
              <div>
                ...
                <div className="booking-grid">
                  <div>
                    <input className="booking-input" type="date" value={pickupDate}
                      onChange={e => setPickupDate(e.target.value)} style={{ ...inputStyle("pickupDate"), colorScheme: "dark" }} />
                    {errors.pickupDate && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.pickupDate}</span>}
                  </div>
                  <div>
                    <input className="booking-input" type="time" value={pickupTime}
                      onChange={e => setPickupTime(e.target.value)} style={{ ...inputStyle("pickupTime"), colorScheme: "dark" }} />
                    {errors.pickupTime && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.pickupTime}</span>}
                  </div>
                </div>
              </div>
              ...
              {tripType === "roundtrip" && (
                <div>
                  ...
                  <div className="booking-grid">
                    <div>
                      <input className="booking-input" type="date" value={returnDate}
                        onChange={e => setReturnDate(e.target.value)} style={{ ...inputStyle("returnDate"), colorScheme: "dark" }} />
                      {errors.returnDate && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.returnDate}</span>}
                    </div>
                    <div>
                      <input className="booking-input" type="time" value={returnTime}
                        onChange={e => setReturnTime(e.target.value)} style={{ ...inputStyle("returnTime"), colorScheme: "dark" }} />
                      {errors.returnTime && <span style={{ fontSize: "11px", color: "#e87070", marginTop: "5px", display: "block" }}>{errors.returnTime}</span>}
                    </div>
                  </div>
                </div>
              )}
              ...
              {/* INFO NOTE */}
              <div style={{
                padding: "14px 18px", background: "rgba(201,169,110,0.06)",
                border: `1px solid ${borderGold}`, borderRadius: "10px",
                fontSize: "13px", color: "rgba(232,226,217,0.55)", lineHeight: "1.7", fontWeight: 300,
              }}>
                ℹ Pricing will be discussed and confirmed via WhatsApp based on your route and requirements.
              </div>

              {/* SUBMIT */}
              <button className="btn-gold" onClick={handleRequest} style={{
                width: "100%", padding: "17px", borderRadius: "14px",
                fontSize: "13px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
              }}>
              ...
              <div style={{ textAlign: "center" }}>
                <span style={{ fontSize: "12px", color: "rgba(232,226,217,0.28)", letterSpacing: "1px" }}>OR</span>
              </div>
              <a href="tel:+919872130111" style={{ textDecoration: "none" }}>
                <button className="btn-outline" style={{ width: "100%", padding: "15px", borderRadius: "14px", fontSize: "13px" }}>
                  Call +91 98721 30111
                </button>
              </a>
    ...
    <div>
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", overflow: "hidden" }}>
        <div style={{
          ...
          backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.22)",
        }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(8,8,8,0.92) 45%, rgba(8,8,8,0.6) 100%)" }} />
        ...
        <div ref={heroRef} className="fade-up" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "0 32px", paddingTop: "80px", width: "100%" }}>
          <div className="hero-grid">
            <div>
              ...
              <h1 className="serif" style={{ fontSize: "clamp(44px,7vw,78px)", fontWeight: 400, lineHeight: 1.05, color: "#f5ede0", marginBottom: "22px" }}>
                Executive<br /><span style={{ fontStyle: "italic", color: gold }}>Mobility</span><br />Redefined
              </h1>
              <p style={{ fontSize: "clamp(14px,1.6vw,16px)", lineHeight: "1.8", color: "rgba(232,226,217,0.55)", maxWidth: "400px", marginBottom: "36px", fontWeight: 300 }}>
              ...
              <div className="hero-stats" style={{ marginTop: "48px", paddingTop: "36px", borderTop: `1px solid ${border}` }}>
                {[["25+","Years Experience"],["24/7","Available"],["100%","Professional"]].map(([n,l]) => (
                  <div key={l}>
                    ...
                    <div style={{ fontSize: "11px", color: "rgba(232,226,217,0.45)", marginTop: "5px" }}>{l}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="hero-right float" style={{
              ...
              <div>
                {services.map((s, i) => (
                  <button key={s.title} onClick={() => setPage(s.isDriver ? "driver" : "contact")} style={{
                    ...
                    transition: "color 0.3s", color: "#e8e2d9",
                  }}
        ...
        <div style={{ position: "absolute", bottom: "32px", left: "50%", transform: "translateX(-50%)", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
          <div style={{ fontSize: "9px", letterSpacing: "3px", color: "rgba(232,226,217,0.25)", textTransform: "uppercase" }}>Scroll</div>
      ...
      <section className="section-pad">
        <div ref={s2} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div className="service-grid">
            {services.map(s => (
              <button key={s.title}
                onClick={() => setPage(s.isDriver ? "driver" : "contact")}
                className="card-hover service-card-btn"
                style={{
                  padding: "30px 22px", background: bgCard,
                  border: `1px solid ${border}`, borderRadius: "18px",
                  backdropFilter: "blur(20px)", cursor: "pointer",
                  textAlign: "left", width: "100%",
                  /* FIX: explicit color so browser default black is overridden */
                  color: "#e8e2d9",
                }}>
                <div style={{
                ...
                <h3 className="serif" style={{ fontSize: "20px", fontWeight: 500, color: "#f5ede0", marginBottom: "9px" }}>{s.title}</h3>
                <p style={{ fontSize: "13px", lineHeight: "1.7", color: "rgba(232,226,217,0.52)", fontWeight: 300 }}>{s.desc}</p>
      ...
      {/* RATES */}
      <section className="section-pad" style={{ background: "rgba(201,169,110,0.025)", borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
        <div ref={s3} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "52px" }}>
            ...
            <div className="divider-gold" style={{ margin: "12px auto 22px" }} />
            <h2 className="serif" style={{ fontSize: "clamp(30px,4vw,50px)", fontWeight: 400, color: "#f5ede0", marginBottom: "10px" }}>Chandigarh ↔ Delhi</h2>
            <p style={{ color: "rgba(232,226,217,0.45)", fontSize: "14px" }}>One-way executive rates. No hidden charges.</p>
          </div>
          <div className="rates-grid">
            <div style={{ border: `1px solid ${border}`, borderRadius: "22px", padding: "36px", background: bgCard, backdropFilter: "blur(20px)", transition: "border-color 0.4s, transform 0.4s" }}
              ...
              <h3 className="serif" style={{ fontSize: "clamp(22px,3vw,30px)", fontWeight: 400, color: "#f5ede0", marginBottom: "6px" }}>Etios · Aura · Dzire</h3>
              <p style={{ color: "rgba(232,226,217,0.4)", fontSize: "13px", marginBottom: "26px" }}>4 passengers · Comfortable & reliable</p>
              <div style={{ borderTop: `1px solid ${border}`, paddingTop: "22px", display: "flex", alignItems: "baseline", gap: "8px" }}>
                ...
                <button className="onwards-link" onClick={() => setPage("contact")}
                  style={{ color: "rgba(232,226,217,0.4)", fontSize: "14px", background: "none", border: "none", fontFamily: "'Manrope',sans-serif", cursor: "pointer" }}>
                  onwards ↗
                </button>
              </div>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              {[
                ...
                <div key={item.name} style={{ border: `1px solid ${border}`, borderRadius: "22px", padding: "28px", background: bgCard, backdropFilter: "blur(20px)", flex: 1, transition: "border-color 0.4s, transform 0.4s" }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = borderGold; e.currentTarget.style.transform = "translateY(-3px)"; }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = border; e.currentTarget.style.transform = "none"; }}>
                  <div className="tag" style={{ marginBottom: "10px" }}>{item.tag}</div>
                  <h3 className="serif" style={{ fontSize: "clamp(18px,2.5vw,24px)", fontWeight: 400, color: "#f5ede0", marginBottom: "4px" }}>{item.name}</h3>
                  <p style={{ color: "rgba(232,226,217,0.4)", fontSize: "12px", marginBottom: "18px" }}>{item.spec}</p>
                  <div style={{ borderTop: `1px solid ${border}`, paddingTop: "16px", display: "flex", alignItems: "baseline", gap: "8px" }}>
                    ...
                    <button className="onwards-link" onClick={() => setPage("contact")}
                      style={{ color: "rgba(232,226,217,0.4)", fontSize: "13px", background: "none", border: "none", fontFamily: "'Manrope',sans-serif", cursor: "pointer" }}>
                      onwards ↗
                    </button>
                  </div>
                </div>
      ...
      <section className="section-pad" style={{ textAlign: "center" }}>
        <div ref={s4} className="fade-up" style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(232,226,217,0.45)", fontSize: "15px", lineHeight: "1.8", marginBottom: "38px", fontWeight: 300 }}>
...
function ServicesPage({ setPage }) {
  ...
  return (
    <div style={{ paddingTop: "70px" }}>
      <section className="section-pad" style={{ textAlign: "center", background: "linear-gradient(180deg, rgba(201,169,110,0.05) 0%, transparent 100%)", borderBottom: `1px solid ${border}` }}>
        <div ref={r1} className="fade-up">
          <div className="tag" style={{ marginBottom: "14px" }}>Pioneer Travels</div>
          <div className="divider-gold" style={{ margin: "14px auto 24px" }} />
          <h1 className="serif" style={{ fontSize: "clamp(42px,6vw,68px)", fontWeight: 400, color: "#f5ede0", marginBottom: "16px" }}>Our Services</h1>
          ...
          <div className="services-cat-grid">
            {categories.map(cat => (
              <button key={cat.title} onClick={() => setPage("contact")} className="card-hover"
                style={{ padding: "40px 32px", background: bgCard, border: `1px solid ${border}`, borderRadius: "22px", backdropFilter: "blur(20px)", cursor: "pointer", textAlign: "left", width: "100%", color: "#e8e2d9" }}>
        ...
        <div ref={r3} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "24px" }}>
            {[
              ...
              <div key={s.title} style={{ padding: "40px 32px", background: bgCard, border: `1px solid ${borderGold}`, borderRadius: "22px", backdropFilter: "blur(20px)" }}>
                <div style={{ width: "48px", height: "48px", borderRadius: "14px", border: `1px solid ${borderGold}`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "22px" }}>
          ...
          <div className="stats-grid" style={{ marginTop: "56px", border: `1px solid ${border}`, borderRadius: "18px", overflow: "hidden" }}>
            {[["25+","Years of Service"],["24/7","Availability"],["Professional","Chauffeurs"],["Fixed","Transparent Rates"]].map(([n,l],i,arr) => (
              <div key={l} style={{ padding: "38px 20px", textAlign: "center", background: bgCard, borderRight: i < arr.length - 1 ? `1px solid ${border}` : "none" }}>
                ...
                <div style={{ fontSize: "10px", letterSpacing: "1.5px", textTransform: "uppercase", color: "rgba(232,226,217,0.35)" }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
...
function FleetPage({ setPage }) {
  ...
  const VehicleCard = ({ name, tag, spec }) => (
    <div className="card-hover" style={{ padding: "22px 18px", background: bgCard, border: `1px solid ${border}`, borderRadius: "14px" }}>
      <div style={{ fontSize: "9px", fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase", color: gold, marginBottom: "9px" }}>{tag}</div>
      <h4 className="serif" style={{ fontSize: "19px", fontWeight: 400, color: "#f5ede0", marginBottom: "4px" }}>{name}</h4>
      ...
      <div ref={innerRef} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "44px", flexWrap: "wrap" }}>
          <div>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 400, color: "#f5ede0" }}>{title}</h2>
          </div>
    ...
    <div style={{ paddingTop: "70px" }}>
      <section className="section-pad" style={{ textAlign: "center", background: "linear-gradient(180deg, rgba(201,169,110,0.05) 0%, transparent 100%)", borderBottom: `1px solid ${border}` }}>
        <div ref={r1} className="fade-up">
          <div className="tag" style={{ marginBottom: "14px" }}>Pioneer Travels</div>
          <div className="divider-gold" style={{ margin: "14px auto 24px" }} />
          <h1 className="serif" style={{ fontSize: "clamp(42px,6vw,68px)", fontWeight: 400, color: "#f5ede0", marginBottom: "16px" }}>Our Fleet</h1>
        ...
        <div ref={r4} className="fade-up" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "44px", flexWrap: "wrap" }}>
            <div>
              ...
              <h2 className="serif" style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 400, color: "#f5ede0" }}>Luxury Fleet</h2>
            </div>
            <div style={{ flex: 1, height: "1px", background: border, minWidth: "20px" }} />
          </div>
          ...
          <div style={{ textAlign: "center", padding: "36px 28px", border: `1px solid ${borderGold}`, borderRadius: "18px", background: "rgba(201,169,110,0.04)" }}>
            <p className="serif" style={{ fontSize: "21px", color: "#f5ede0", fontStyle: "italic", marginBottom: "6px" }}>Additional vehicles available on request</p>
            <p style={{ color: "rgba(232,226,217,0.38)", fontSize: "13px", marginBottom: "22px", fontWeight: 300 }}>Based on availability and travel requirements</p>
    ...
    <div style={{ paddingTop: "70px" }}>
      <section className="section-pad" style={{ textAlign: "center", background: "linear-gradient(180deg, rgba(201,169,110,0.05) 0%, transparent 100%)", borderBottom: `1px solid ${border}` }}>
        <div ref={r1} className="fade-up">
          ...
          <div className="divider-gold" style={{ margin: "14px auto 24px" }} />
          <h1 className="serif" style={{ fontSize: "clamp(42px,6vw,68px)", fontWeight: 400, color: "#f5ede0", marginBottom: "16px" }}>Book a Ride</h1>
          <p style={{ color: "rgba(232,226,217,0.48)", fontSize: "15px", maxWidth: "440px", margin: "0 auto", fontWeight: 300, lineHeight: 1.8 }}>
            Call or WhatsApp for instant booking. Available 24 hours, 7 days a week.
          </p>
        </div>
      </section>
      ...
      <section className="section-pad">
        <div ref={r2} className="fade-up" style={{ maxWidth: "780px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="contact-grid">
            {[
              ...
              <a key={c.label} href={c.href} style={{ textDecoration: "none" }}>
                <div className="card-hover" style={{ padding: "30px 26px", background: bgCard, border: `1px solid ${border}`, borderRadius: "18px", cursor: "pointer", backdropFilter: "blur(16px)", height: "100%" }}>
                  <div style={{ fontSize: "10px", letterSpacing: "2px", textTransform: "uppercase", color: gold, marginBottom: "12px" }}>{c.label}</div>
                  <h3 className="serif" style={{ fontSize: "clamp(20px,3.5vw,26px)", fontWeight: 400, color: "#f5ede0", marginBottom: "5px" }}>{c.number}</h3>
                  <p style={{ fontSize: "12px", color: "rgba(232,226,217,0.35)" }}>Tap to call directly</p>
          ...
          <a href="https://wa.me/919872130111" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
            <div style={{
              padding: "26px 30px", background: "rgba(37,211,102,0.06)", border: "1px solid rgba(37,211,102,0.18)", borderRadius: "18px",
              display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", backdropFilter: "blur(16px)", flexWrap: "wrap", gap: "12px",
              ...
              <div>
                ...
                <div style={{ fontSize: "12px", color: "rgba(232,226,217,0.35)", marginTop: "3px" }}>Chat with us instantly</div>
              </div>
          ...
          <div style={{ textAlign: "center", padding: "34px", background: bgCard, border: `1px solid ${border}`, borderRadius: "18px", backdropFilter: "blur(16px)" }}>
            <p className="serif" style={{ fontSize: "22px", color: "#f5ede0", fontStyle: "italic", marginBottom: "8px" }}>Pioneer Travels</p>
            <p style={{ color: "rgba(232,226,217,0.35)", fontSize: "13px", lineHeight: "1.8", fontWeight: 300 }}>
              Available 24 hours · 7 days a week<br />Chandigarh · Delhi · Pan North India
            </p>
          </div>
        </div>
      </section>
...
function Footer({ setPage }) {
  return (
    <footer style={{ borderTop: `1px solid ${border}`, padding: "52px 32px 34px", background: "#040404" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div className="footer-grid" style={{ marginBottom: "40px" }}>
          <div style={{ maxWidth: "240px" }}>
            <div style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 300, fontSize: "15px", letterSpacing: "5px", color: "#e8e2d9", textTransform: "uppercase", marginBottom: "12px" }}>
              PIONEER <span style={{ color: gold }}>TRAVELS</span>
            </div>
            <p style={{ fontSize: "13px", color: "rgba(232,226,217,0.3)", lineHeight: "1.7", fontWeight: 300 }}>
            ...
            <div>
              ...
              {[["home","Home"],["services","Services"],["driver","Driver On Demand"],["fleet","Fleet"],["contact","Book Now"]].map(([p,l]) => (
                <div key={p} style={{ marginBottom: "10px" }}>
                  <button onClick={() => setPage(p)} style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "'Manrope',sans-serif", fontSize: "13px", color: "rgba(232,226,217,0.42)", fontWeight: 300, transition: "color 0.3s", padding: 0 }}
                    onMouseEnter={e => e.target.style.color = gold} onMouseLeave={e => e.target.style.color = "rgba(232,226,217,0.42)"}>{l}</button>
                </div>
              ))}
            </div>
            <div>
              ...
              <a href="tel:+919872130111" style={{ textDecoration: "none" }}>
                <div style={{ marginBottom: "10px", fontSize: "13px", color: "rgba(232,226,217,0.42)", fontWeight: 300 }}>+91 98721 30111</div>
              </a>
              <a href="tel:+919917600079" style={{ textDecoration: "none" }}>
                <div style={{ marginBottom: "10px", fontSize: "13px", color: "rgba(232,226,217,0.42)", fontWeight: 300 }}>+91 99176 00079</div>
              </a>
              <a href="https://wa.me/919872130111" style={{ textDecoration: "none" }}>
        ...
        <div style={{ borderTop: `1px solid ${border}`, paddingTop: "20px", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "10px" }}>
          <p style={{ fontSize: "11px", color: "rgba(232,226,217,0.18)", fontWeight: 300 }}>© {new Date().getFullYear()} Pioneer Travels. All rights reserved.</p>
          <p style={{ fontSize: "11px", color: "rgba(232,226,217,0.18)", fontWeight: 300 }}>Chandigarh · Delhi · Pan North India</p>
        </div>
      </div>
    </footer>
  );
